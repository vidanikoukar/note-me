                        ...
                        <div class="card-actions">
                            ...
                            @auth
                                @if (Auth::id() === $post->user_id)
                                    <a href="{{ route('posts.edit', $post->id) }}" class="read-btn">
                                    ...
                                    <form action="{{ route('posts.destroy', $post->id) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="read-btn btn-danger" onclick="return confirm('آیا مطمئن هستید؟');">
    ...
    poetryCards.forEach(card => {
        card.addEventListener('click', function(e) {
            if (!e.target.closest('.read-btn')) {
                const readBtn = this.querySelector('.read-btn:not(.btn-danger)');
                if (readBtn) {
                    readBtn.click();
                }
            }
