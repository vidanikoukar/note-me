    ...
    <div class="page-hero">
        ...
        <div class="hero-content">
            <div class="hero-glass-card">
                <h1 class="hero-title">
                    <span class="title-text">شعر و متن‌های زیبا</span>
                ...
                <form class="filter-form" method="GET" action="{{ route('posts.index') }}">
                    <div class="filter-row">
                        <div class="form-group">
                            ...
                            <select class="form-control modern-select" id="category_id" name="category_id" onchange="this.form.submit()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="search-wrapper">
                                <input type="text" class="form-control search-input" id="search" name="search" value="{{ request('search') }}" placeholder="جستجوی عنوان یا محتوا...">
                ...
                <article class="poetry-card" data-category="{{ $post->category->name ?? 'نامشخص' }}">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-actions">
                            <a href="{{ route('posts.show', $post->id) }}" class="action-btn primary">
                                <span>مطالعه</span>
                                <i class="bi bi-arrow-left"></i>
                            </a>
                            @auth
        ...
        <div class="create-section">
            <div class="create-glass-card">
                <div class="create-content">
                    ...
                    <h3 class="create-title">داستان شما کجاست؟</h3>
                    <p class="create-text">آیا شعر، داستان یا دلنوشته‌ای دارید که می‌خواهید با دنیا به اشتراک بگذارید؟</p>
