                    ...
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="excerpt"
                                      ...
                                      placeholder="خلاصه‌ای کوتاه و جذاب از پست (برای نمایش در لیست پست‌ها)">{{ old('excerpt') }}</textarea>
                            @error('excerpt')
                        ...
                        <div class="form-group">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 hover-transition">
                                <input type="file" 
                                       id="featured_image"
                                       name="featured_image" 
                                       accept="image/*"
                                ...
                                <label for="featured_image" class="cursor-pointer">
                                    ...
                                    <p class="text-sm text-gray-600">برای انتخاب تصویر کلیک کنید</p>
                                    <p class="text-xs text-gray-500 mt-1">JPG, PNG, JPEG - حداکثر 2MB</p>
                                </label>
                    ...
                    <div>
                        ...
                        <div class="border border-gray-200 rounded-lg p-6 mb-6">
                            ...
                            <div class="form-group">
                                ...
                                <p class="mt-1 text-xs text-gray-500">توصیه: 50-60 کاراکتر</p>
                                @error('meta_title')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="meta_description"
                                          ...
                                          rows="3"
                                          class="form-input @error('meta_description') error @enderror" 
                                          placeholder="توضیحات کوتاه برای موتورهای جستجو">{{ old('meta_description') }}</textarea>
                                <p class="mt-1 text-xs text-gray-500">توصیه: 150-160 کاراکتر</p>
                        ...
                        <div class="border border-gray-200 rounded-lg p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    ...
                                    <label for="published" class="mr-3 text-sm font-medium text-gray-700">
                                        انتشار فوری پست
                                    </label>
                                </div>
                                ...
                                <div class="text-sm text-gray-500 bg-gray-50 p-3 rounded-lg">
                                    <div class="flex items-start">
                                        <svg class="w-4 h-4 ml-2 mt-0.5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <div>
                                            <p class="font-medium">راهنما:</p>
                                            <p>✓ انتشار فوری: پست بلافاصله برای کاربران قابل مشاهده خواهد بود</p>
                                            <p>✗ پیش‌نویس: پست ذخیره می‌شود اما منتشر نمی‌شود</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    document.getElementById('postForm').addEventListener('submit', function(e) {
        ...
        if (title.length < 5) {
            e.preventDefault();
            alert('عنوان پست باید حداقل 5 کاراکتر باشد.');
            return false;
        }
        
        if (content.length < 50) {
            e.preventDefault();
            alert('محتوای پست باید حداقل 50 کاراکتر باشد.');
            return false;
        }
    });
    ...
    function autoSave() {
        ...
        // This would typically send an AJAX request to save draft
